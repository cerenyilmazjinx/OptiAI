...
#[derive(Debug)]
pub struct OptiAIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OptiAIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OptiAI processing");
    
    let mut processor = OptiAIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OptiAIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OptiAIProcessor::new(false);
